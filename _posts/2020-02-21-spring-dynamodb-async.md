---
layout: default
title:  "Java Microservice: Reactive Rest Client to DynamoDB using Spring Boot"
date:   2020-02-21 15:14
tags:   [java, aws, microservice, spring]
repository_url: https://github.com/yegor-bond/poc/tree/master/spring-dynamodb-async
description: Starting from Spring framework 5.0 and Spring Boot 2.0, the framework provides support for asynchronous programming, 
...
_Small hint:_ starting from java 10 you can specify how much memory JVM will use depending on container memory.
...
EXPOSE 8080
```
So building the docker container itself `docker build -t spring-dynamo .` 
